...
"""
    Load an image and convert it to grayscale. Credit: hw2 distribution.
...
"""
    Mirror an image about its border. Credit: hw2 distribution.
...
"""
    Pad an image with zeros about its border. Credit: hw2 distribution.
...
"""
    Remove the border of an image. Credit: hw2 distribution.
...
"""
    ...
    by applying the Sobel operator. Credit: hw2 distribution.
...
"""
    ...
    direction perpendicular to the edge. Credit: hw2 distribution.
...
"""
    ...
    Canny edge detector with nonmax suppression. Credit: adapted from hw2 distribution.
    ...
    Returns:
      ...
      theta    - edge orientation at each pixel in range [0, 2*pi]
"""
